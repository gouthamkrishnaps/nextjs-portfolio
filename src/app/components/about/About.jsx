...
import developer from "@home/assets/developer.svg";
  ...
  return (
    <div className="h-screen w-full grid grid-cols-3 ">
      <div className=" flex justify-center items-center ">
        <div className="bg-blue-200 p-[40px] rounded-[10%] shadow-lg h-[350px] w-[350px] flex justify-center items-center ">
          {" "}
          <Image width={400} height={200} alt="developer" src={developer} />
        </div>
      </div>
      <div className=" p-[20px] flex justify-center items-center col-span-2">
        <div className="h-[70%] w-[70%]">
          <h3 className="text-blue-400 font-semibold text-[16px] text-left">
            ABOUT ME
          </h3>
          <p className=" text-[30px] text-left ">
            More Than 1 + Years of Experience in Programming
          </p>
          <p className="text-gray-400">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis
            atque nobis hic expedita, fugit quae sed consectetur reprehenderit
            tenetur a recusandae eius at ducimus voluptates eveniet nisi labore!
            Excepturi, magnam? Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Error, eum. Illo voluptatum sit mollitia eos,
            recusandae cupiditate. Repellat maiores id placeat iste! Temporibus
            doloremque fuga cumque, repellat et tenetur illo.
          </p>
          <div className="grid grid-cols-2 py-8">
            <p className="text-gray-400 py-2">
              <span className="font-semibold text-black">Name :</span> Goutham
              Krishna ps
            </p>
            <p className="text-gray-400  py-2">
